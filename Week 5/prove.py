...
if ans == 'match'.lower():
    ...
    if ans == 'hide'.lower():
        ...
        if ans == 'follow'.lower():
            ans = input("""You follow the path and you eventually come upon a house. You arent sure if you want to go inside or not,
        ...
        if ans == 'look'.lower():
            ans = input("""You look in the trees and you see a strange creature lunge out at you. Youre pretty scared at this point
